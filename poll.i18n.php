...
<input type="submit" value="View" />
    ...
    'wikipoll-flags-voters-open'        => 'Open: voter names are displayed in results',
    'wikipoll-flags-voters-closed'      => 'Closed: voter names can be viewed only in administration',
    'wikipoll-flags-results-open'       => 'Poll results are shown for all users, including non-voters',
    'wikipoll-flags-results-closed'     => 'Poll results are shown only to voters',
...
* Всего проголосовал{{PLURAL:$1||о}} $1 человек.
    ...
    'wikipoll-points'                   => '<span style="color: #0080ff"> (отдан{{PLURAL:$1||о}} $1 голос{{PLURAL:$1||а|ов}})</span>',
...
<input type="submit" value="Просмотреть" />
    ...
    'wikipoll-flags-voters-open'        => 'Открытое голосование: имена всех голосующих отображаются в результатах',
    'wikipoll-flags-voters-closed'      => 'Закрытое голосование: имена голосующих можно посмотреть только в режиме администрирования',
    'wikipoll-flags-results-open'       => 'Результаты голосования открыты для всех, в том числе и тех, кто ещё не голосовал',
    'wikipoll-flags-results-closed'     => 'Результаты открываются только после голосования',
